...
public class TelemetryEventSender implements Runnable {
  ...
  private static final ApacheHttpClientFactory HTTP_CLIENT_FACTORY = ApacheHttpClientFactory.getInstance();
  ...
  protected static HttpClient getHttpClient() {
    return defaultHttpClient != null ? defaultHttpClient : HTTP_CLIENT_FACTORY.createHttpClient( HTTP_CALL_TIMEOUT );
  }
